...
#### 1.5.8: Additional resources on available security policies
...
#### 1.7.2: Click on your plan and select **_Published_**
![Homepage](images/900/image112.png)

#### 1.7.3: Select **_Yes_** to publish the entitlement
![Homepage](images/900/image113.png)

#### 1.7.4: Confirm that the API is published
![Homepage](images/900/image114.png)


## 1.8: Configure Publication

#### 1.8.1: Enter Portal Name, and click **_Save_**
![Homepage](images/900/image915.png)

#### 1.8.2: Enter Portal Name, and click **_Save_**
![Homepage](images/900/image915.png)

#### 1.8.3: Click **_Publish to Portal_**
![Homepage](images/900/image916.png)

#### 1.8.4: Confirm that you have an API Portal URL generated
...
## 1.11: Subscribe Application to a API
