...
- Explore Integration Cloud Service (AIC) to become familiar with it's service console and functionality.
...
This is the first of several labs that are part of the **AIC Development** workshop. 

In this lab, we will explore the main parts of Integration Cloud Service (AIC).  You will acquire a good overview of the Oracle Integration Cloud Service (AIC), the next generation integration platform. You will explore various consoles and tools available to interact with your integration. The exercise will get your familiar with all the tooling available to work with this cloud service. 

We’ll look at the following:
1.	Oracle Cloud Services Dashboard
2.	AIC Designer User Interface
3.	AIC Monitoring User Interface
