...
#### 1.5.5: Enter your expression in quotes in the expression box
![Logger](images/600/image624.png)

#### 1.5.6: Validate the expression, and click **_Close_**
...
##### 1.1.12.7: Drag and drop the **_Directory_** and **_Filename_** components from the **_Source_** field, to the **_Target_**
