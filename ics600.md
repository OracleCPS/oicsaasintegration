...
#### 1.1.3: Click the **_Create_** button located on right top corner
...
**_NOTE_**: Delete the mapper that gets created between the FTP adapter and the schedule adapter. Click on the Mapper, select the hamburger menu, and choose **_Delete_**. There is nothing to map between these two adapters.
...
#### 1.5.3: Enter name information
![forEach](images/600/image628.png)

#### 1.5.3: Drag and drop the **_File_** component under **_Source_** onto the **_Repeating Element_** field
![forEach](images/600/image629.png)

#### 1.5.4: **_Provide Current Element Name_** and click **_Create_**
![forEach](images/600/image628.png)
...
## 1.6: Configure a FTP Adapter that will Download the File to Oracle Integration Cloud


#### 1.6.1: Click the circle icon from the right hand side menu and select FTP. Drag the FTP Adapter you created after the **_forEach_** function
...
#### 1.6.8: Click validate, and Close
![FTP](images/600/image636.png)

**_NOTE_**: Save your integration.


## 1.7: Configure a FTP Adapter That will Archive the Downloaded File from Oracle Integration Cloud

#### 1.7.1: Click the circle icon from the right hand side menu and select **_FTP_**. Drag the FTP Adapter you created in Lab 300 after the FTP adapter you configured above
![Scheduled](images/600/image608.png)

#### 1.7.2: Enter adapter endpoint name and Click **_Next_**
![FTP](images/600/image637.png)

#### 1.7.3: Select the **_Operations_** to perform. Select **_Move a File_** under Select Operation, and Provide **_Target Directory Path_**. Click **_Next_**
...
#### 1.7.13: Select the String 1 text field, and drag and drop the **_Substring-Before_** function
![FTP](images/600/image647.png)

#### 1.7.14: Expand the Source field 
![FTP](images/600/image648.png)

#### 1.7.15: Drag and drop the **_filename_** component from Source onto string 1 
![FTP](images/600/image650.png)

**_NOTE_**: Before dragging, double click on string 1, so that the text box field appears.
![FTP](images/600/image649.png)

#### 1.7.16: Double click on Sting 2, and type in .zip in quotes
![FTP](images/600/image651.png)

#### 1.7.16: Drag and drop the **_concat_** function from **_Mapping Components_** onto the last String 2 text field
![FTP](images/600/image652.png)

#### 1.7.17: Double click on String 1 and drag and drop the **_current-dateTime_** function 
![FTP](images/600/image654.png)

![FTP](images/600/image655.png)

#### 1.7.18: Click **_Save_** and **_Close_**
![FTP](images/600/image657.png)


##### 1.7.19: Validate and Close
![FTP](images/600/image658.png)

**_NOTE_**: Save your integration.


## 1.8: Configure ERP Adapter

#### 1.8.1: Click on the Circle Icon on the Right Hand Side Menu. Select Oracle ERP Cloud, and Choose the ERP Adapter You Created
...
#### 1.8.6: Select the mapper that got generated to the left of the ERP adapter, and click on the pencil icon
...
#### 1.9.3: Configure the **_From_** Field. Click on the Pencil Icon
![FTP](images/600/image671.png)

#### 1.9.4: In the text box under **_Expression_**, hard code the email address for the From field. Click on the refresh icon to view **_Expression Summary_**.
![FTP](images/600/image672.png)

#### 1.9.5: Validate expression, and **_Close_**
![FTP](images/600/image673.png)

#### 1.9.6: Configure the **_To_** Field. Click on the pencil icon
![FTP](images/600/image674.png)

##### 1.9.7: In the text box under Expression, hard code the email address for the To field. Click on the refresh icon to view **_Expression Summary_**.
![FTP](images/600/image672.png)

##### 1.9.8: Validate expression, and **_Close_**
![FTP](images/600/image675.png)


#### 1.9.9: Configure the **_Subject_** Field. Click on the pencil icon
![FTP](images/600/image676.png)


##### 1.9.10: Select the **_concat_** function from under components
![FTP](images/600/image677.png)


#### 1.9.11: Drag and drop the **_concat_** function in the text box below Expression 
![FTP](images/600/image678.png)

#### 1.9.12: Replace string1 with "Fusion ERP Cloud Upload submitted successfully through ICS. Your Confirmation Code from ERP." Keep the quotes, and the comma after.
![FTP](images/600/image679.png)

#### 1.9.13: Remove string2. Drag the **_Result_** component from the source field, and drop it after the comma. 
![FTP](images/600/image680.png)


#### 1.9.14: Validate Expression, and Close
![FTP](images/600/image681.png)


#### 1.9.15: In the **_Body_** Field, type in 'No Body Required' 
![FTP](images/600/image682.png)

##### 1.9.16: Validate Notification, and **_Close_**
![FTP](images/600/image683.png)


#### 1.9.17: Resolve Integration Error
![FTP](images/600/image684.png)

#### 1.9.18: Click on the hamburger menu on the right, and select **_Tracking_**
![FTP](images/600/image685.png)

#### 1.9.19: Drag and drop **_startTime_** from the source field, to the Tracking Field. Click save.
![FTP](images/600/image686.png)


**_NOTE_**: Save Your Integration, and click close.

## 1.10: Activate Integration

#### 1.10.1: Locate your integration in the integration section under Designer
![FTP](images/600/image689.png)

#### 1.10.2: Turn the activation switch to the right
![FTP](images/600/image690.png)


#### 1.10.3: Select **_Enable Tracing_** and **_Including Payload_**. Click **_Activate_**
![FTP](images/600/image691.png)

#### 1.10.4: Confirm that the integration is activated
![FTP](images/600/image692.png)


## 1.11: Run Integration

#### 1.11.1: Click on the back arrow next to **_Designer_**
![FTP](images/600/image693.png)

#### 1.11.2: Select **_Monitoring_**
![FTP](images/600/image694.png)

#### 1.11.3: Select **_Integrations_**
![FTP](images/600/image695.png)

#### 1.11.4: Click on the arrow icon to run the integration
![FTP](images/600/image696.png)

#### 1.11.5: Confirm the integration run successfully.
![FTP](images/600/image697.png)

#### 1.11.6: Select **_Tracking_** from the left hand side menu
![FTP](images/600/image698.png)

#### 1.11.7: Click on the refresh icon to view your integration under Tracking
![FTP](images/600/image699.png)

#### 1.11.8: Confirm your integration run is completed successfully. Click on the refresh icon again if your integration is still in progress.
