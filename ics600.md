...
#### 1.1.17.7: Select **_Tracking_** from the left hand side menu
[FTP](images/600/image698.png)

#### 1.1.17.8: Click on the refresh icon to view your integration under Tracking
[FTP](images/600/image699.png)

#### 1.1.17.9: Confirm your integration run is completed successfully. Click on the refresh icon again if your integration is still in progress.
[FTP](images/600/image699.png)
