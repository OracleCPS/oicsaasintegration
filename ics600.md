...
#### 1.9.11: Select the **_concat_** function from under components
...
#### 1.9.13: Replace string1 with "Fusion ERP Cloud Upload submitted successfully through ICS. Your Confirmation Code from ERP". Keep the quotes, and the comma after.
...
#### 1.9.18: Resolve Integration Error
![FTP](images/600/image684.png)

#### 1.9.19: Click on the hamburger menu on the right, and select **_Tracking_**
![FTP](images/600/image685.png)

#### 1.9.20: Drag and drop **_startTime_** from the source field, to the **_Tracking Field_**. Click **_save_**.
