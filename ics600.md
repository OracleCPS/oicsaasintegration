...
Let's start by logging into the Oracle Integration Cloud, and configuring an integrtion.
...
#### 1.1.11: Configure a ForEach Funciton
...
##### 1.1.13.3: Configure the Service and Operation as Follows, and Click **_Next_**
![FTP](images/600/image662.png)

##### 1.1.13.4: Confirm information on Summary page, and Click **_Done_**
![FTP](images/600/image663.png)

##### 1.1.13.5: Select the Mapper that got Generated to the Left of the ERP adapter, and Click on the Pencil Icon
![FTP](images/600/image664.png)


##### 1.1.13.6: Map the Following Components from the Sourc Field on the Left to the Components on the Target Field
![FTP](images/600/image665.png)

NOTE: Once mapping is done, make sure to validate before closing.


#### 1.1.14: Configure Notification

##### 1.1.14.1: Select the Flag Icon on the Righ Hand Side Menu. Select Notification Under General
...
##### 1.1.14.3: Configure the **_From_** Field
![FTP](images/600/image669.png)

##### 1.1.14.4: Configure the **_To_** Field
![FTP](images/600/image669.png)

##### 1.1.14.5: Configure the **_Subject_** Field
![FTP](images/600/image669.png)

##### 1.1.14.6: Configure the **_Body_** Field
![FTP](images/600/image669.png)
