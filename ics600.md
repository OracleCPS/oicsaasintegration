...
**_NOTE_**: Delete the Mapper Function that gets created between the FTP adapter and the schedule adapter. Click on the Mapper, select the hamburger menu, and choose **_Delete_**. There is nothing to map between these two adapters.
