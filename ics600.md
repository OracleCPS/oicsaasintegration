...
#### 1.1.8: Configure the FTP Adaptor Endpoint

###### 1.1.8.1:
Indicate filename and Click Next:
![Filename](images/600/image609.png)

Provide Selection Operation, Input Directory, File Name Pattern, Max Files and Click Next:
![Filename](images/600/image610.png)

Confirm the information you entered is correct in the Summary section, and click **_Done_**:
...
![forEach](images/600/image630.png)
...
#### 1.1.12: Configure an FTP Adapter That Will Download the File to Oracle Integration Cloud
...
##### 1.1.12.7: Drag and Drop the Directory and Filename Componenets from the Source field, to the Target
