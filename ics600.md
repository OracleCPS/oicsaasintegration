...
#### 1.2.1: Click on the Circle Icon on the Far Right, and Select FTP from the list under Invokes
![Scheduled](images/600/image607.png)

#### 1.2.2: When the List Expands, Drag the FTP Adapter You Created onto the Grey Arrow Under the Schedule Adapter
...
###### 1.2.3: Indicate filename and Click **_Next_**
![Filename](images/600/image609.png)

#### 1.2.4: Provide Selection Operation, Input Directory, File Name Pattern, Max Files and Click Next
![Filename](images/600/image610.png)

#### 1.2.5: Confirm the information you entered is correct in the Summary section, and click **_Done_**
![Filename](images/600/image612.png)


**_NOTE_**: Delete the Mapper Function that gets created. Click on the Mapper, select the hamburger menu, and choose Delete.
