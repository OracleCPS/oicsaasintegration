...
#### 1.1.4: Click on the hamburger menu to the right
...
Now, let's create the integration that will download the invoice from ERP and load it to an FTP Server.
...
## 1.3: Configure the ERP Cloud Adapter Endpoint that will Download the Payment
...
## 1.4: Configure Mapper to Download Payment
...
#### 1.4.4: Hardcode the process Id retrieved from ERP Cloud after generating an invoice
...
#### 1..81: Locate your integration in the integration section under Designer
