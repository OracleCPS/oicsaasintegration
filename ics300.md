...
#### 4.1.2: Type Sales in the **_Search_** box on the Top Right and Select **_Oracle Sales CLoud** from the Dropdown List
...
#### 4.1.9: Click on **_Save_** then **_Close_**
...
#### 5.1.2: Type Service in the **_Search_** box on the Top Right and Select **_Oracle Service Cloud (RightNow)** from the Dropdown List
...
#### 4.1.5: Provide the WSDL URL and click OK

![menu](images/300/image705.png)


#### 4.1.6: Click on **_Configure Security_** under **_Security_**
![menu](images/300/image301.png)
